...
describe('EngineUser', () => {
    ...
    it('should allow setting Authority ID on new users', () => {
        expect(() => (user.authority_id = 'empty-authority')).toThrowError()
        const new_user = new EngineUser(service, {})
        new_user.authority_id = 'my-authority'
    ...
    it('should allow setting login name', () => {
        user.login_name = 'warrior_of_light'
