...
describe('EngineSystem', () => {
    ...
    it('should expose settings', () => {
        expect(system.settings).toEqual({ test: 1 })
        system.settings = { pink_floyd: 'yeah' }
        expect(system.settings).not.toEqual({ pink_floyd: 'yeah' })
        expect(system.changes.settings).toEqual({ pink_floyd: 'yeah' })
    })
