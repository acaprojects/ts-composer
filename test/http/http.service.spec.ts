import { EngineHttpClient, engine } from '../../src/http/http.service'
...
describe('EngineHttpClient', () => {
    ...
    describe('GET', () => {
        ...
        it('should allow requests', done => {
            ...
            expect(engine.ajax.get).toBeCalledWith('test_url', { Authorization: 'test_token' })
        })
        ...
        it('should allow custom headers', () => {
            ...
            service
                ...
                .subscribe(_ => null)
            expect(engine.ajax.get).toBeCalledWith('test_url', {
    ...
    describe('POST', () => {
        beforeEach(() => {
            auth.has_token = false
            spy = jest.spyOn(engine.ajax, 'post')
            spy.mockImplementation(() =>
                of({
                    status: 200,
        ...
        it('should allow requests', done => {
            ...
            expect(engine.ajax.post).toBeCalledWith('test_url', 'test_body', {
                Authorization: 'test_token'
            })
        })
    ...
    describe('PUT', () => {
        beforeEach(() => {
            auth.has_token = false
            spy = jest.spyOn(engine.ajax, 'put')
            spy.mockImplementation(() =>
                of({
                    status: 200,
        ...
        it('should allow requests', done => {
            ...
            expect(engine.ajax.put).toBeCalledWith('test_url', 'test_body', {
                Authorization: 'test_token'
            })
        })
        ...
        it('should prevent requests until auth is loaded', () => {
            ...
            auth.has_token = true
            jest.runOnlyPendingTimers()
            expect(engine.ajax.put).toBeCalledWith(
                'test_url',
                { test: 'body' },
                { Authorization: 'test_token' }
            )
    ...
    describe('PATCH', () => {
        beforeEach(() => {
            auth.has_token = false
            spy = jest.spyOn(engine.ajax, 'patch')
            spy.mockImplementation(() =>
                of({
                    status: 200,
        ...
        it('should allow requests', done => {
            ...
            expect(engine.ajax.patch).toBeCalledWith('test_url', 'test_body', {
                Authorization: 'test_token'
            })
        })
        ...
        it('should prevent requests until auth is loaded', () => {
            ...
            auth.has_token = true
            jest.runOnlyPendingTimers()
            expect(engine.ajax.patch).toBeCalledWith(
                'test_url',
                { test: 'body' },
                { Authorization: 'test_token' }
            )
    ...
    describe('DELETE', () => {
        beforeEach(() => {
            auth.has_token = false
            spy = jest.spyOn(engine.ajax, 'delete')
            spy.mockImplementation(() =>
                of({
                    status: 200,
        ...
        it('should allow requests', done => {
            ...
            expect(engine.ajax.delete).toBeCalledWith('test_url', { Authorization: 'test_token' })
        })
